...
//        patch.setLocalPath(Environment.getExternalStorageDirectory().getPath()+ File.separator+"robust"+File.separator + "patch");
        patch.setLocalPath(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() + File.separator + "patch");
    ...
    protected boolean verifyPatch(Context context, Patch patch) {
        ...
        try {
            Log.d(PatchManipulateImp.class.getSimpleName(), "#### verifyPatch: localPath:" + patch.getLocalPath() + " tempPath:" + patch.getTempPath());
    ...
    public void copy(String srcPath, String dstPath) throws IOException {
        Log.d(PatchManipulateImp.class.getSimpleName(), "#### copy srcPath:" + srcPath + " dstPath:" + dstPath);
